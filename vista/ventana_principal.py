...
class VentanaPrincipal(tk.Frame):
    ...
    def make_components(self):
        ...
        self.label_title = tk.Label(self.frame_title, text="----", width=40)
    ...
    def show_label_volume(self, event=None):
        ...
        self.label_volume.place(height=50, width=50, y=5, x=350)
    ...
    def create_components_volume(self):
        ...
        self.btn_volumen = tk.Button(
            self.frame_volumen,
            image=self.photoimages["icon_altavoz"],
            command=self.muted,
        )
        self.btn_volumen.grid(row=0, column=0)

        self.var_volume = tk.DoubleVar()
        self.after_volume = None

        self.label_volume = ttk.Label(
            self,
            text="--",
        ...
        ttk.Style().configure(
            "vol.Horizontal.TScale", background="skyblue", troughcolor="white"
        )
        ttk.Style().map(
            "vol.Horizontal.TScale",
            background=[("pressed", "!disabled", "skyblue"), ("active", "skyblue")],
        )
    ...
    def create_components_time(self):
        ...
        self.style_scale.configure(
            "custom.Horizontal.TScale", background="magenta", troughcolor="white"
        )
        self.style_scale.map(
            "custom.Horizontal.TScale",
            background=[("pressed", "!disabled", "magenta"), ("active", "magenta")],
        )
        ...
        self.label_duration = tk.Label(self.frame_time, text="--:--")
    ...
    def create_components_control(self):
        ...
        self.frame_btn.grid(row=4, column=0, sticky="WE")
        ...
        self.btn_next = tk.Button(
            self.frame_btn,
            image=self.photoimages["icon_next"],
            command=self.next_track,
            width=100,
        )
        self.btn_previous = tk.Button(
            self.frame_btn,
            image=self.photoimages["icon_previous"],
    ...
    def create_components_visual(self):
        ...
        self.frames = [
            tk.PhotoImage(file="imagenes/nofunciona.gif", format="gif -index %i" % (i))
            for i in range(40)
        ]
    ...
    def create_components_track(self):
        ...
        self.listbox = tk.Listbox(self.frame_track, relief="flat", height=22)
